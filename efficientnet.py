...
def EfficientNet(width_coefficient,
    ...
    x = tf.keras.layers.Activation(tf.nn.swish, name='stem_activation')(x)
    # Build blocks
...
def EfficientNetB0(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.0, 1.0, 512, 0.2,
...
def EfficientNetB1(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.0, 1.1, 640, 0.2,
...
def EfficientNetB2(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.1, 1.2, 768, 0.3,
...
def EfficientNetB3(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.2, 1.4, 896, 0.3,
...
def EfficientNetB4(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.4, 1.8, 1024, 0.4,
...
def EfficientNetB5(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.6, 2.2, 1280, 0.4,
...
def EfficientNetB6(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.8, 2.6, 1408, 0.5,
...
def EfficientNetB7(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(2.0, 3.1, 1536, 0.5,
