...
from augmentor import imgaug_augmentation
...
class Generator(keras.utils.Sequence):
    ...
    def __init__(
        ...
        self.aug_seq = imgaug_augmentation.get_base_aug_seq()
    ...
    def compute_inputs_targets(self, group, debug=False):
        ...
        if self.set_name=='train':
            image_group, annotations_group = self.augment_images(image_group, annotations_group)
